...
def apply_csp(response):
    response.headers['Content-Security-Policy'] = "default-src 'self'; script-src 'self' https://cdn.socket.io; connect-src 'self' http://127.0.0.1:5000; style-src 'self' 'unsafe-inline';"
    return response
